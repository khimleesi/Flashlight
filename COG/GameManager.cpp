...
GameManager::GameManager()	
	:	m_endGame(false),
		...
		m_timestep(0.0f)
{
	FL_LOG("[GAME MANAGER CONSTRUCT]", FL_LOG_EMPTY, LOG_BREAK);
}
...
void GameManager::Shutdown()
{
	...
	FL_LOG("[GAME MANAGER SHUT DOWN]", FL_LOG_EMPTY, LOG_BREAK);
}
...
{
	Audio::Instance()->LoadAudio("Menu", "Music\\Menu.mp3", true);
